            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <div class="row mb-5">
                            <div class="col-12 ">
                                <h2 class="site-section-heading text-center">Concert Gallery</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach ($event as $item)
                        @if ($item->post_as === 'concert')
                            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 item" data-aos="fade"
                                ...
                                data-sub-html="<h4>{{ $item->title }}</h4><p>{{ $item->content }}</p>">
                                <a href="#"><img src="{{ Storage::url($item->thumbnail) }}" alt="Image"
                                        class="img-fluid"></a>
                            </div>
                        @endif
                    @endforeach
            ...
            <div class="container-fluid text-center">
                <p>
                    ...
                    <script>
                        ...
                        aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Fourfold</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
