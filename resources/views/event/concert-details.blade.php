...
<body>
    ...
    <main class="s-home s-home--slides">
        ...
        <div class="home-slider">
            ...
            <div class="home-slider-img">
                <video autoplay muted loop playsinline>
                    <source src="assets-event/video/dayconcert.mp4" type="video/mp4">
                </video>
            </div>

            <div class="home-slider-img">
                <video autoplay muted loop playsinline>
                    <source src="assets-event/video/festival3.mp4" type="video/mp4">
                </video>
            </div>
        ...
        <div class="home-content">
            ...
            <div class="home-content__main">
                ...
                <div class="col-eight home-content__text pull-right">
                    ...
                    <h1>
                        Let us organize your dream concert into a spectacular and memorable moment.
                    </h1>

                    <p>
                        Do you love concerts? Then you need Fourfold Organizer, the best event organizer for concert
                        music.
                        We can create and manage any kind of concert, from indie to EDM, from rock to rap.
                        We have the coolest venues, stages, and artists to make your festival music a blast.
                        We will also take care of the tickets, security, and promotion, so you can have fun and enjoy
                        the music.
                    </p>
