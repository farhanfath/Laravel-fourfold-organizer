      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="../test">Event</a></li>
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="../admin/login">Admin</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="page-section portfolio" id="partner">
      <div class="container">
        ...
        <div class="divider-custom">
          <div class="divider-custom-line"></div>
          {{-- <div class="divider-custom-icon"><i class="fa fa-circle"></i></div>
          <div class="divider-custom-line"></div> --}}
        </div>
        <!-- Partner Grid Items-->
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ $i }}">
                    <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                        <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-external-link fa-3x"></i></div>
                    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($youtube)
                <a class="btn btn-outline-light btn-social mx-1" href="{{ $youtube }}" target="blank">
